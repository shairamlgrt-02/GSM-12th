...
const HomeBlockRenderer = ({ block, setActiveTab }) => {
  ...
  switch (block.type) {
    case 'hero':
      return (
        <div id={block.id} onClick={handleLink} className={`${commonClasses} relative rounded-3xl overflow-hidden shadow-2xl group`}>
    ...
    case 'countdown':
      ...
      return (
        <div id={block.id} onClick={handleLink} className={`${commonClasses} bg-emerald-900 rounded-3xl p-8 text-center text-white shadow-xl`}>
    ...
    case 'grid':
      return (
        <div id={block.id} onClick={handleLink} className={`${commonClasses} grid grid-cols-3 gap-2 md:gap-6`}>
